  ...
  return (
    <div className="animate-fade-in">
      <section className="mb-12 border-b border-slate-200 pb-8">
        ...
        <p className="mt-4 text-lg leading-7 text-slate-600 dark:text-slate-400">work i&apos;ve done over the years</p>
      </section>
        ...
        <ul className="flex flex-col gap-8">
          {projects.map((project) => (
            ...
            >
              ...
              <p className="mt-3 text-base leading-7 text-slate-600 dark:text-slate-400">{project.description}</p>
